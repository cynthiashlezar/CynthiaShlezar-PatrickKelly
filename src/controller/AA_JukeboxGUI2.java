...
import view.AA_JukeboxView2;

public class AA_JukeboxGUI2 extends JFrame {
	
	private Jukebox jukebox;
	private AA_JukeboxView2 view;
	private static final int width = 800;
	private static final int height = 600;
	
	public AA_JukeboxGUI2() {
		setup();
	...
	private void setup() {
		jukebox = new Jukebox();
		view = new AA_JukeboxView2(jukebox);
		addAllObservers();
		add(view);
		view.repaint();
		view.revalidate();
	...
	public static void main(String [] args) {
		AA_JukeboxGUI2 g = new AA_JukeboxGUI2();
		g.setVisible(true);
	}
